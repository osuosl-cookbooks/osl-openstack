...
neutron.agent.linux.iptables_firewall.IptablesFirewallDriver$/,
    ...
    context 'Setting controller vxlan_interface to eth0 on controller' do
      ...
      before do
        ...
        node.default['osl-openstack']['vxlan_interface']['controller'] \
          ['default'] = 'eth0'
    ...
    context 'Setting controller vxlan_interface to downed eth2' do
      ...
      before do
        node.default['osl-openstack']['node_type'] = 'controller'
        node.default['osl-openstack']['vxlan_interface']['controller']['default'] = 'eth2'
    ...
    context 'Setting controller vxlan_interface to eth0 on compute' do
      cached(:chef_run) { runner.converge(described_recipe) }
      before do
        node.default['osl-openstack']['node_type'] = 'compute'
        node.automatic['network']['interfaces']['eth0']['addresses'] = {
          '192.168.1.10' => {
            'family' => 'inet',
          },
    ...
    context 'Setting controller vxlan_interface to eth8 on compute w/ fqdn' do
      ...
      before do
        node.default['osl-openstack']['node_type'] = 'compute'
        node.default['osl-openstack']['vxlan_interface']['compute'] \
    ...
    context 'physical_interface_mappings is empty by default' do
      ...
      [
        ...
        before do
          node.default['osl-openstack']['physical_interface_mappings'] = []
        end
        it do
          expect(chef_run).to render_config_file(file.name)
