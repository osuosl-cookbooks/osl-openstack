...
cookbook 'ceph-chef', github: 'osuosl-cookbooks/ceph-chef', branch: 'ramereth/chef16'
...
cookbook 'osl-ceph', git: 'git@github.com:osuosl-cookbooks/osl-ceph', branch: 'kennedy/chef-16'
